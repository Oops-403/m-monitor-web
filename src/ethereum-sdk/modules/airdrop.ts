...
export class Airdrop {
  ...
  public async toClaimToken (web3Provider: Web3Provider, amount: string, signature: string) {
  ...
  public async userClaimedAmount (provider: JsonRpcProvider | Web3Provider, amount: string, userAddress: string) {
    const claimAmount = ethers.utils.formatUnits(amount, 18)
