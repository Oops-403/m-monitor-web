import { BigNumberish, BigNumber, BaseContract, ContractInterface, utils } from 'ethers'

export const ERC20ABI: Exclude<ContractInterface, utils.Interface>= [
  {
    'constant': true,
    'inputs': [],
    'name': 'name',
...
export const enum ERC20Function {
  Name = 'name',
  Symbol = 'symbol',
  Version = 'version',
  Decimals = 'decimals',
